...
Verify the **Web** platform contains the configured local callbacks and the deterministic environment callbacks generated by bootstrap, including:

```text
https://localhost:7262/signin-oidc
https://app-<workload>-web-<environment>-<resource-suffix>.azurewebsites.net/signin-oidc
```
